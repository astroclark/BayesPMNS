...
#           phi0=90.0)
    ...
    #hp, hc = lalsim.SimRingdownChirp(1.0/16384, int_params.Amp,
    #        2.0*np.pi*int_params.f0, int_params.df, Q, 0.0, 0.0, 0.0, 2, 2)
    hp, hc = lalsim.SimRingdownChirp(1.0/16384, int_params.Amp,
            int_params.f0, 0.0, Q, 0.0, 0.0, 0.0, 2, 2)
...
f=open('RDChirp_%s.txt'%sys.argv[1], "w")
