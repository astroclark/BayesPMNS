...
\makeatother
\centering
\subfloat[Cumulative Eigenenergy]{%
...
\caption{\emph{Left}: Cumulative eigenenergies for the three sets of principle
components; \emph{Right}: matches for waveforms reconstructed using PCs based on
