...
\veryHuge \color{NavyBlue} \textbf{Principle Component Analysis Of Post-Merger
Gravitational Wave Burst Signals From Binary Neutron Star Coalescene} \color{Black}\\ \\% Title
\huge \textbf{James A. Clark$^{1}$, Andreas Bauswein$^{2}$}\\ \\% Author(s)
\large 1. Georgia Institude of Technology\\ % University/organization
\large 2. University of Thessaloniki\\ % University/organization
\end{minipage}
%
\hspace{10cm}
%
...
\makeatother
\centering
\subfloat[Explained Variance]{%
    \includegraphics[width=0.4\linewidth]{eigenenergy.pdf}%
  \label{fig:}%
}\qquad%
...
\subfloat[Idealised match for full-spectrum PCs]{%
  \includegraphics[width=0.4\linewidth]{fullspec_ideal_matches.pdf}%
  \label{fig:}%
}\qquad%
\subfloat[Idealised match for full-spectrum PCs]{%
  \includegraphics[width=0.4\linewidth]{shiftspec_ideal_matches.pdf}%
  \label{fig:}%
}
...
\makeatother
\centering
\subfloat[Idealised match for low-frequency PCs]{%
  \includegraphics[width=0.4\linewidth]{lowfreq_ideal_matches.pdf}%
  \label{fig:}%
}\qquad%
\subfloat[Idealised match for high-frequency PCs]{%
  \includegraphics[width=0.4\linewidth]{highfreq_ideal_matches.pdf}%
  \label{fig:}%
}
...
\subfloat[Idealised match for `stiched' PCs]{%
  \includegraphics[width=0.4\linewidth]{stitchedspec_ideal_matches.pdf}%
  \label{fig:}%
}\qquad%
\subfloat[Idealised match for `shifted' PCs]{%
  \includegraphics[width=0.4\linewidth]{unshiftspec_ideal_matches.pdf}%
  \label{fig:}%
}
\caption{Separate high and low frequency matches}
\end{minipage}
