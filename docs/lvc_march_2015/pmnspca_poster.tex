...
Bursts:  A Post-Merger Model} \color{Black}\\ \\% Title
...
\begin{center}%\vspace{1cm}
    ...
    \captionof{figure}{\label{fig:distances} Burst \& Matched Filter Ranges}
\end{center}%\vspace{1cm}
...
\begin{center}%\vspace{1cm}
    ...
    \captionof{figure}{\label{fig:eigenergy} Explained Variance}
\end{center}%\vspace{1cm}
